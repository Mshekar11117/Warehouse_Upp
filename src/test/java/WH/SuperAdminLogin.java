...
public class SuperAdminLogin extends SuperTestNG {
	...
	test = extent.createTest("Super Admin Flow");
...
//		childTest.log(Status.PASS, MarkupHelper.createLabel("Find all the links in the page and Verif the links and images are broken or not", ExtentColor.BLUE));
		...
		CD.VerifyValuesinViewandEdit();
		childTest = test.createNode("VerifyValuesinViewandEdit");
		childTest.log(Status.PASS, MarkupHelper.createLabel("Verify the data between View and Edit module", ExtentColor.BLUE));
